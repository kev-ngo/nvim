...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    ...
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ["cmp-npm"] = {
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/cmp-npm",
  ...
  ["nightfox.nvim"] = {
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/nightfox.nvim",
  ...
  ["nvim-notify"] = {
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/nvim-notify",
